...
#include <memory>
#include "../../SistemaFerreteria2020/reportes.h"
...
QT_MOC_LITERAL(1, 9, 9), // "back_menu"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 32) // "on_id_regresardereportes_clicked"

    },
    "Reportes\0back_menu\0\0"
    "on_id_regresardereportes_clicked"
};
...
void Reportes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Reportes *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->back_menu(); break;
        case 1: _t->on_id_regresardereportes_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Reportes::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Reportes::back_menu)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Reportes::staticMetaObject = { {
    ...
    qt_meta_stringdata_Reportes.data,
    qt_meta_data_Reportes,
    qt_static_metacall,
    nullptr,
    nullptr
} };
