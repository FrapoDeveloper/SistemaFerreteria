...
public:
    ...
    void setupUi(QWidget *Menu)
    {
        ...
        ventana_menu->setGeometry(QRect(0, -30, 1024, 751));
        ...
        numero_sedes = new QLabel(Menu);
        numero_sedes->setObjectName(QString::fromUtf8("numero_sedes"));
        numero_sedes->setGeometry(QRect(780, 140, 201, 31));
        lista_sedes = new QListWidget(Menu);
        lista_sedes->setObjectName(QString::fromUtf8("lista_sedes"));
        lista_sedes->setGeometry(QRect(70, 610, 271, 71));
        l_sedes = new QLabel(Menu);
        l_sedes->setObjectName(QString::fromUtf8("l_sedes"));
        l_sedes->setGeometry(QRect(70, 580, 141, 21));
        l_sedes->setFont(font2);
    ...
    void retranslateUi(QWidget *Menu)
    {
        ...
        numero_sedes->setText(QString());
        l_sedes->setText(QCoreApplication::translate("Menu", "Nuestras Sedes: ", nullptr));
    } // retranslateUi
